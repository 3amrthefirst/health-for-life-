    ...
    <div class="right-content">
      <header class="header">
        ...
        <a href="{{ route('admin.dashboard') }}">
  				<img src="{{asset('assets/imgs/dtsocial.png')}}" alt="" class="side-logo" />
        </a>
            ...
            <div class="form-row">
              <div class="col-md-12 mb-3">
                <div class="form-group">
                  ...
                  <input name="title" type="text" class="form-control" id="title"value="@if($data){{$data->title}}@endif" placeholder="Please Enter Title" autocomplete="off">
                </div>
              </div>
            </div>
            <div class="form-row">
